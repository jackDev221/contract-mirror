...
public class CurveAbi extends Contract {
    ...
    public enum Events implements IEvent {
        ...
        ADD_LIQUIDITY2("AddLiquidity", "address indexed,uint256[2],uint256[2],uint256,uint256"),
        ADD_LIQUIDITY3("AddLiquidity", "address indexed,uint256[3],uint256[3],uint256,uint256"),
        REMOVE_LIQUIDITY2("RemoveLiquidity", "address indexed,uint256[2],uint256[2],uint256"),
        REMOVE_LIQUIDITY3("RemoveLiquidity", "address indexed,uint256[3],uint256[3],uint256"),
        REMOVE_LIQUIDITY_ONE("RemoveLiquidityOne", "address indexed,uint256,uint256"),
        REMOVE_LIQUIDITY_IMBLANCE2("RemoveLiquidityImbalance",
                                   "address indexed,uint256[2],uint256[2],uint256,uint256"),
        REMOVE_LIQUIDITY_IMBLANCE3("RemoveLiquidityImbalance",
                                   "address indexed,uint256[3],uint256[3],uint256,uint256"),
