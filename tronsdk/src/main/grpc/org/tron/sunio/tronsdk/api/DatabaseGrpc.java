...
public final class DatabaseGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage,
      org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference> getGetBlockReferenceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBlockReference",
      requestType = org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage.class,
      responseType = org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage,
      org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference> getGetBlockReferenceMethod() {
    io.grpc.MethodDescriptor<org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage, org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference> getGetBlockReferenceMethod;
      ...
      synchronized (DatabaseGrpc.class) {
        if ((getGetBlockReferenceMethod = DatabaseGrpc.getGetBlockReferenceMethod) == null) {
          DatabaseGrpc.getGetBlockReferenceMethod = getGetBlockReferenceMethod =
              io.grpc.MethodDescriptor.<org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage, org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage,
      org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetDynamicProperties",
      requestType = org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage.class,
      responseType = org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage,
      org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod() {
    io.grpc.MethodDescriptor<org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage, org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties> getGetDynamicPropertiesMethod;
      ...
      synchronized (DatabaseGrpc.class) {
        if ((getGetDynamicPropertiesMethod = DatabaseGrpc.getGetDynamicPropertiesMethod) == null) {
          DatabaseGrpc.getGetDynamicPropertiesMethod = getGetDynamicPropertiesMethod =
              io.grpc.MethodDescriptor.<org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage, org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties.getDefaultInstance()))
  ...
  public static abstract class DatabaseImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getBlockReference(org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference> responseObserver) {
      asyncUnimplementedUnaryCall(getGetBlockReferenceMethod(), responseObserver);
    }

    /**
     */
    public void getDynamicProperties(org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage request,
        io.grpc.stub.StreamObserver<org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                ...
                org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference>(
          ...
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage,
                org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties>(
  ...
  public static final class DatabaseBlockingStub extends io.grpc.stub.AbstractBlockingStub<DatabaseBlockingStub> {
     ...
     * </pre>
     */
    public org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference getBlockReference(org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage request) {
    ...
    /**
     */
    public org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties getDynamicProperties(org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage request) {
      return blockingUnaryCall(
  ...
  public static final class DatabaseFutureStub extends io.grpc.stub.AbstractFutureStub<DatabaseFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference> getBlockReference(
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties> getDynamicProperties(
        org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BLOCK_REFERENCE:
          serviceImpl.getBlockReference((org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage) request,
              (io.grpc.stub.StreamObserver<org.tron.sunio.tronsdk.api.GrpcAPI.BlockReference>) responseObserver);
          break;
        case METHODID_GET_DYNAMIC_PROPERTIES:
          serviceImpl.getDynamicProperties((org.tron.sunio.tronsdk.api.GrpcAPI.EmptyMessage) request,
              (io.grpc.stub.StreamObserver<org.tron.sunio.tronsdk.protos.Protocol.DynamicProperties>) responseObserver);
          break;
