package org.tron.sunio.tronsdk.common.utils;
...
import org.tron.sunio.tronsdk.common.crypto.ByteUtil;
import org.tron.sunio.tronsdk.common.crypto.jce.TronCastleProvider;
...
public class Hash {
    ...
    static {
        ...
        EMPTY_TRIE_HASH = sha3(encodeElement(new byte[0]));
    }
